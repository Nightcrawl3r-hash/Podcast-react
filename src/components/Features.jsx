  ...
  return (
    <div className="bg-white relative">
      <img
        ...
        src={image1}
        alt="mic-image"
        className=" hidden md:flex absolute h-64 w-1/5"
      />
      <div className="container overflow-hidden m-auto flex flex-col gap-4 justify-center items-center py-16">
        <p
          data-aos="fade-down"
          className="playfair text-4xl text-center md:w-3/5 "
        >
          We make your
        ...
        <p
          data-aos="fade-down"
          className="py-2 text-gray-700 md:w-3/5 text-center"
        >
        ...
        <div
          data-aos="fade-up"
          className="grid lg:grid-cols-4 gap-6 justify-center items-center"
        >
          <FeaturedTile
            //bg={`d1f6f3`}
            //color={`1bd0c3`}
...
function FeaturedTile({ comp, title, subtitle, }) {
